...
public class SoilPressureCalculatorUtil {
    ...
    public double calculateLateralPressure(double depth){
        ...
        if(depth <= waterTableDepth){
            ...
            result.addReportLine(String.format("           = %.2f x %.2f x %.2f + 2 x %.2f x sqrt(%.2f);", kp, unitWeight, depth, cohesion, kp), "=", String.format("%.2f kN/m²", lateralPressure));
        }else{
            ...
            result.addReportLine(String.format("           = (%.2f x %.2f x %.2f) + 2 x %.2f x sqrt(%.2f);", kp, unitWeight, heightAboveWT, cohesion, kp), "=", String.format("%.2f kN/m²", lateralPressure));
        }
    ...
    public double calculatePassivePressure(double pressureAbove, double pressureBelow, double height){
        ...
        result.addReportLine(String.format("           = ((%.2f+%.2f)/2) x %.2f;", pressureAbove, pressureBelow, height), "=", String.format("%.2f kN/m²", passivePressure));
