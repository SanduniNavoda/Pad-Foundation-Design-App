...
import com.sedceng.padfoundation.entity.*;

/**
 *
 * @author Sanduni Navoda
 */
public class StubColumnDto {
    ...
    public StubColumnDto() {
    }

    public StubColumnDto(double width, double breadth, double heightBelowSoil, double heightAboveSoil) {
        this.width = width;
        this.breadth = breadth;
        this.heightOfColumn = heightBelowSoil + heightAboveSoil;
    ...
    /**
     * @param heightBelowSoil
     * @param heightAboveSoil
     * the heightOfColumn to set
     */
    public void setHeightOfColumn(double heightBelowSoil, double heightAboveSoil) {
        this.heightOfColumn = heightBelowSoil + heightAboveSoil;
    }
