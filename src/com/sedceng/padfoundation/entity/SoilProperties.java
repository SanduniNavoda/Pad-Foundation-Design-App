...
public class SoilProperties {
    ...
    public SoilProperties(double internalFrictionAngle, double frictionAngleWithFoundation, double bulkUnitWeight, double saturatedUnitWeight, double waterUnitWeight, double cohesion, double waterTableDepth) {
    ...
    public String toString() {
        return "SoilProperties{" + "internalFrictionAngle=" + internalFrictionAngle + ", frictionAngleWithFoundation=" + frictionAngleWithFoundation + ", bulkUnitWeight=" + bulkUnitWeight + ", saturatedUnitWeight=" + saturatedUnitWeight + ", waterUnitWeight=" + waterUnitWeight + ", cohesion=" + cohesion + ", waterTableDepth=" + waterTableDepth + ", kp=" + kp + '}';
    }
