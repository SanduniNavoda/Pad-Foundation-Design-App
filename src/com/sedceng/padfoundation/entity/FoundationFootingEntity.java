 ...
 */
public class FoundationFootingEntity {
    ...
    public FoundationFootingEntity() {
    }

    public FoundationFootingEntity(double widthOfFooting, double breadthOfFooting, double heightOfFooting, double widthOfColumn, double breadthOfColumn, double columnHeightAboveGround, double columnHeightBelowGround, double unitWeightOfConcrete, double foundationDepth) {
    ...
    public String toString() {
        return "FoundationFootingEntity{" + "widthOfFooting=" + widthOfFooting + ", breadthOfFooting=" + breadthOfFooting + ", heightOfFooting=" + heightOfFooting + ", widthOfColumn=" + widthOfColumn + ", breadthOfColumn=" + breadthOfColumn + ", columnHeightAboveGround=" + columnHeightAboveGround + ", columnHeightBelowGround=" + columnHeightBelowGround + ", unitWeightOfConcrete=" + unitWeightOfConcrete + ", foundationDepth=" + foundationDepth + '}';
    }
