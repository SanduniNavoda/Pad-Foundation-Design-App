 ...
 */
public class ServiceabilityLoadsEntity {
    ...
    public ServiceabilityLoadsEntity() {
    }

    public ServiceabilityLoadsEntity(Double compressiveForce, Double tensileForce, Double horizontalTransverseForce, Double horizontalLongitudinalForce) {
